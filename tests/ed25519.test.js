...
test('master key from seed', () => {
   ...
   */
  const chain = Ed25519.getMasterKeyFromSeed(hexSeed)
  ...
  expect(Ed25519.getPublicKey(chain.key).toString('hex')).
...
test('derivePath m/0\' from seed', () => {
   ...
   */
  const chain = Ed25519.derivePath('m/0\'', hexSeed)
...
test('derivePath m/0\'/2147483647\' from seed', () => {
   ...
   */
  const chain = Ed25519.derivePath('m/0\'/2147483647\'', hexSeed)
...
test('derivePath m/0\'/2147483647\'/1\' from seed', () => {
   ...
   */
  const chain = Ed25519.derivePath('m/0\'/2147483647\'/1\'', hexSeed)
...
test('derivePath m/0\'/2147483647\'/1\'/2147483646\' from seed', () => {
   ...
   */
  const chain = Ed25519.derivePath('m/0\'/2147483647\'/1\'/2147483646\'', hexSeed)
...
test('derivePath m/0\'/2147483647\'/1\'/2147483646\'/2\' from seed', () => {
   ...
   */
  const chain = Ed25519.derivePath('m/0\'/2147483647\'/1\'/2147483646\'/2\'', hexSeed)
