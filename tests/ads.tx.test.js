...
test('parse broadcast', () => {
  ...
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('broadcast')
...
test('parse change_account_key', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('change_account_key')
...
test('parse change_node_key', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('change_node_key')
  expect(parsedData[Ads.Tx.TX_FIELDS.PUBLIC_KEY]).toBe(
    'EAE1C8793B5597C4B3F490E76AC31172C439690F8EE14142BB851A61F9A49F0E',
  )
  // sender
...
test('parse create_account', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('create_account')
  expect(parsedData[Ads.Tx.TX_FIELDS.PUBLIC_KEY]).toBe(
...
test('parse create_node', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('create_node')
  // sender
  expect(parsedData[Ads.Tx.TX_FIELDS.SENDER]).toBe('0001-00000000-9B6F')
  expect(parsedData[Ads.Tx.TX_FIELDS.MESSAGE_ID]).toBe(1)
...
test('parse get_account', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('get_account')
...
test('parse get_accounts', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('get_accounts')
...
test('parse get_block', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('get_block')
...
test('parse get_blocks', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('get_blocks')
...
test('parse get_broadcast', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('get_broadcast')
...
test('parse get_log', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('get_log')
  // sender
  expect(parsedData[Ads.Tx.TX_FIELDS.SENDER]).toBe('0001-00000000-9B6F')
...
test('parse get_message', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('get_message')
...
test('parse get_message_list', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('get_message_list')
  expect(parsedData[Ads.Tx.TX_FIELDS.BLOCK_ID]).toBe('5B4893C0')
  // sender
  expect(parsedData[Ads.Tx.TX_FIELDS.SENDER]).toBe('0002-00000001-659C')
  expect(parsedData[Ads.Tx.TX_FIELDS.TIME]).toEqual(new Date(1531483110 * 1000))
...
test('parse get_signatures', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('get_signatures')
...
test('parse get_transaction', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('get_transaction')
...
test('parse get_vipkeys', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('get_vipkeys')
...
test('parse log_account', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('log_account')
  // sender
  expect(parsedData[Ads.Tx.TX_FIELDS.SENDER]).toBe('0002-00000001-659C')
  expect(parsedData[Ads.Tx.TX_FIELDS.MESSAGE_ID]).toBe(1)
...
test('parse retrieve_funds', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('retrieve_funds')
...
test('parse send_many', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('send_many')
...
test('parse send_one', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('send_one')
  expect(parsedData[Ads.Tx.TX_FIELDS.ADDRESS]).toBe('0001-00000001-8B4E')
...
test('parse set_account_status', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('set_account_status')
...
test('parse set_node_status', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('set_node_status')
...
test('parse unset_account_status', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('unset_account_status')
  expect(parsedData[Ads.Tx.TX_FIELDS.ADDRESS]).toBe('0001-00000000-9B6F')
...
test('parse unset_node_status', () => {
  ...
  const parsedData = Ads.Tx.decodeCommand(data)
  expect(parsedData[Ads.Tx.TX_FIELDS.TYPE]).toBe('unset_node_status')
